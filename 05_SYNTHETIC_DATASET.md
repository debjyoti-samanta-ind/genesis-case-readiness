...
## Genesis Case Readiness Orchestration · Demo Prototype

All data in this file seeds `src/data/syntheticData.js`. Every field maps to a confirmed Genesis Core data field. Nothing requires Kermit or Meperia access.

---

## HOSPITAL & USER CONTEXT
...
## OR SCHEDULE — THURSDAY 29 MAY 2026

Three orthopaedic cases. Case 1 is AT RISK (PPI deficit). Case 2 is WATCH. Case 3 is CLEAR.
...
export const scheduledCases = [
  {
    ...
    count: 2,           // 2 procedures back to back
...
### Case 1 — Total Knee Arthroplasty (Dr. Chen / Dr. Patel)
...
## INVENTORY LEVELS (REAL-TIME — GENESIS INVENTORY)
...
## DETECTED GAPS (AGENT COMPUTED AT T-72h)
...
export const detectedGaps = [
  {
    ...
    category: "PPI",
    ppiFlag: true,
    governance: "ESCALATE",        // PPI — always human
...
export const vendorReps = [
  {
    ...
    contactChannel: "EMAIL",           // MVP — email only. LKM app tracking is H2.
    loanKitRequest: {
      sentAt: "2026-05-27T02:00:04",   // T-72h agent run
      requestedItems: ["XR7-TIBIAL-42 ×2", "XR7-TIBIAL-44 ×2"],
      responseReceived: false,          // MVP proxy — no structured detection
      hoursElapsed: 26,
      status: "NO_RESPONSE_DETECTED",   // elapsed time only
      mvpProxy: true,
    },
    poOutstandingOrders: {
      status: "OUTSTANDING",
      ...
      mvpProxy: true,                   // Not a physical arrival event
    }
  },
  {
    id: "REP-002",
    ...
    loanKitRequest: null,               // No loan kit needed for Case 2 — sufficient stock
  },
]
```
...
## CHECKPOINT STATE — CASE 1 (AT RISK DEMO SCENARIO)
...
## OUTCOMES VIEW — WEEKLY HISTORICAL DATA (7 DAYS)

This seeds the Outcomes view charts and metrics. Covers Mon 25 May – Thu 29 May 2026.
...
## POST-CASE VARIANCE — SAMPLE (CASE FROM TUE 26 MAY)

This seeds the Post-Case Report view for a completed case.
...
export const samplePostCaseReport = {
  ...
  orRoom: "OR-3",
  reportGeneratedAt: "15:22",          // T+4h after 11:15am case
  ...
  chargeCaptureSummary: {
    gapsDetected: 1,
    estimatedRecoveryValue: 186,       // Monocryl 2-0 × 2 units × $93 standard price
    confidence: "HIGH",
  },
